var TRANSLATIONS = {
  vi: {
    ...
    narration: {
      ...
      body: "<p><span class=\"j-line\">Đình Bình Trường tọa lạc tại xã Bình Chánh, Thành phố Hồ Chí Minh. Căn cứ vào Sắc phong của vua Tự Đức năm 1852, có thể khẳng định ngôi đình đã được</span><span class=\"j-line\">xây dựng trước thời điểm này và có lịch sử hơn hai thế kỷ. Trong hai cuộc kháng chiến chống Pháp và chống Mỹ, đình từng là địa điểm liên lạc và cơ sở hoạt động của cách mạng. Với những giá trị nổi bật về lịch sử, văn hóa và kiến trúc,</span><span class=\"j-line\">ngày 01 tháng 02 năm 2005, đình được xếp hạng Di tích kiến trúc nghệ thuật</span><span class=\"j-last\">cấp Thành phố.</span></p><p><span class=\"j-line\">Bước qua Cổng Tam Quan, du khách sẽ lần lượt tham quan Miếu Bạch Mã,</span><span class=\"j-line\">Bàn Thần Nông, Miếu Thần Hổ, Miếu Bà Ngũ Hành, Bia tưởng niệm liệt sĩ,</span><span class=\"j-line\">Võ Ca, Võ Quy và Chánh điện là trung tâm linh thiêng nhất của đình, nơi thờ</span><span class=\"j-line\">Thành Hoàng Bổn Cảnh. Chánh điện nổi bật với kiến trúc tứ trụ, hệ thống</span><span class=\"j-line\">Bảo lãm, Hoành Phi, Liễn Đối cùng các cột gỗ chạm khắc. Phía sau là Hậu Sở, nơi thờ</span><span class=\"j-line\">các vị thần, tiền nhân và lưu giữ 16 cây gươm giáo cổ, phản ánh nét văn hóa</span><span class=\"j-last\">và nghi lễ truyền thống của đình làng Nam Bộ.</span></p><p><span class=\"j-line\">Đình Bình Trường hiện còn bảo tồn nhiều hiện vật quý như Sắc phong của vua</span><span class=\"j-line\">Tự Đức, lư đồng, trống, mõ, chiêng, hai bộ lỗ bộ bằng đồng, hoành phi, liễn đối,</span><span class=\"j-line\">bao lam, cửa võng cùng nhiều hiện vật thờ cúng có giá trị. Những di sản này</span><span class=\"j-line\">góp phần khẳng định giá trị lịch sử, văn hóa và nghệ thuật đặc sắc của</span><span class=\"j-last\">Đình Bình Trường, một trong những ngôi đình tiêu biểu của vùng đất Bình Chánh.</span></p>",
      button: "Bắt đầu nghe"
    },
    timeline: {
      eyebrow: "Dấu ấn",
      heading: "HƠN 200 NĂM LƯU GIỮ NÉT ĐẸP VĂN HÓA",
      lead: "Được hình thành từ đầu thế kỷ XIX và sắc phong dưới triều vua Tự Đức năm 1852,<br>Đình Bình Trường đã đồng hành cùng sự phát triển của vùng đất Bình Chánh,<br>trở thành chứng nhân của nhiều giai đoạn lịch sử và cách mạng."
    },
    values: {
