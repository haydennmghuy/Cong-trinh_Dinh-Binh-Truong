var TRANSLATIONS = {
  vi: {
    ...
    narration: {
      ...
      body: "<p>Đình Bình Trường tọa lạc tại xã Bình Chánh, Thành phố Hồ Chí Minh. Căn cứ vào<br>Sắc phong của vua Tự Đức năm 1852, có thể khẳng định ngôi đình đã được xây dựng trước thời điểm này và có lịch sử hơn hai thế kỷ. Trong hai cuộc kháng chiến<br>chống Pháp và chống Mỹ, đình từng là địa điểm liên lạc và cơ sở hoạt động<br>của cách mạng. Với những giá trị nổi bật về lịch sử, văn hóa và kiến trúc,<br>ngày 01 tháng 02 năm 2005, đình được xếp hạng Di tích kiến trúc nghệ thuật<br>cấp Thành phố.</p><p>Bước qua Cổng Tam Quan, du khách sẽ lần lượt tham quan Miếu Bạch Mã, Bàn thờ Thần Nông, Miếu Thần Hổ, Miếu Bà Ngũ Hành, Bia tưởng nhiệm liệt sĩ, Võ Ca, Võ Quy và Chánh điện là trung tâm linh thiêng nhất của đình, nơi thờ<br>Thành Hoàng Bổn Cảnh. Chánh điện nổi bật với kiến trúc tứ trụ, hệ thống Bảo lãm, Hoành Phi, Liễn Đối cùng các cột gỗ chạm khắc. Phía sau là Hậu Sở, nơi thờ<br>các vị thần, tiền nhân và lưu giữ 16 cây gươm giáo cổ, phản ánh nét văn hóa<br>và nghi lễ truyền thống của đình làng Nam Bộ.</p><p>Đình Bình Trường hiện còn bảo tồn nhiều hiện vật quý như Sắc phong của vua Tự Đức, lư đồng, trống, mõ, chiêng, hai bộ lỗ bộ bằng đồng, hoành phi, liễn đối, bao lam,<br>cửa võng cùng nhiều hiện vật thờ cúng có giá trị. Những di sản này góp phần<br>khẳng định giá trị lịch sử, văn hóa và nghệ thuật đặc sắc của Đình Bình Trường,<br>một trong những ngôi đình tiêu biểu của vùng đất Bình Chánh.</p>",
      button: "Bắt đầu nghe"
    },
    timeline: {
      eyebrow: "Dấu ấn",
